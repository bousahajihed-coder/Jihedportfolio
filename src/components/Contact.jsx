...
export default function Contact() {
  return (
    <section id="contact" className="relative w-full bg-paper text-ink border-t border-ink/10 py-24 md:py-32">
      <div className="max-w-6xl mx-auto px-6 md:px-10 text-center">
        <Reveal>
          <p className="text-ink/50 text-sm font-medium tracking-[0.3em] uppercase mb-6">Contact</p>
        </Reveal>
        <Reveal delay={0.05}>
        ...
        <Reveal delay={0.1}>
          <p className="text-ink/60 text-base md:text-lg mb-10 max-w-xl mx-auto">
