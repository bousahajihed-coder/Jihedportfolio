...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-ink/80 backdrop-blur-md border-b border-white/10">
      <div className="max-w-6xl mx-auto px-6 md:px-10 h-18 py-4 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="text-sm font-medium border border-white/20 rounded-full px-4 py-2 hover:border-accent hover:text-accent transition-colors"
        >
          Get in touch
        </a>
      </div>
